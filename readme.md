1. 배치 순서 : 김세현 유지현 방효경 정인호 김동진
2. 작업 일정
   DAY 1 (12/1)
      - (공통)19:00 까지 강의 모두 수강 및 자기소개 글 내용 반영
      - (팀장) 12:00 까지 레포지토리 clone 및 팀 레포지토리에 push 완료
      - (팀원) 팀장 push 완료되는대로 로컬 레포지토리에 clone 및 과제 시작
      - (팀원) 21:00까지 PR 생성 및 상호 코드 리뷰 남기기

   DAY 2 (12/2)
      - (공통) 10:30까지 코드 리뷰 확인 및 Merge 및 충돌 해결 (필수과제 완료)
      - (공통) 16:00까지 도전 과제 완료
